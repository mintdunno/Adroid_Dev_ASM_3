...
public class LiveGroupsViewModel extends ViewModel {

    private final GroupRepository groupRepository;
    private final UserRepository userRepository;

    public LiveGroupsViewModel() {
        groupRepository = new GroupRepository();
        userRepository = new UserRepository();
    }

    public LiveData<List<Group>> getLiveGroups() {
        String currentUserId = userRepository.getCurrentUserId();
        return groupRepository.getLiveGroups(currentUserId);
    }
}